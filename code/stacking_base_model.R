...
for(i in 1:n_fold) {
    ...
    write.table(BA_yHat,file="BayesA_yHat_train_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
    ...
    write.table(BB_yHat,file="BayesB_yHat_train_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
    ...
    write.table(BC_yHat,file="BayesC_yHat_train_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
    ...
    write.table(BL_yHat,file="BL_yHat_train_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
    ...
    write.table(BRR_yHat,file="BRR_yHat_train_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
...
write.table(fmBA$yHat[test],file="BayesA_yHat_test_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")

## BayesB test set predict
ETA <-list(list(X=SNP, model="BayesB"))
fmBB <-BGLR(y=yNA, ETA=ETA, nIter=5000, burnIn=1000, saveAt="BayesB_")
write.table(fmBB$yHat[test],file="BayesB_yHat_test_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")

## BayesC test set predict
ETA <-list(list(X=SNP, model="BayesC"))
fmBC <-BGLR(y=yNA, ETA=ETA, nIter=5000, burnIn=1000, saveAt="BayesC_")
write.table(fmBC$yHat[test],file="BayesC_yHat_test_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
...
write.table(fmBRR$yHat[test],file="BRR_yHat_test_stacking_predicted.txt",row.names=F,col.names=F,quote=F, append=F,sep="\n")
